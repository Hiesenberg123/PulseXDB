...
choice2<- matrix(NA, nrow = 5, ncol = 2)%>% as.data.frame()
colnames(choice2)<- c("topic", "sub")
choice2$topic<- c("Leader", "Leader", "Leader", "List", "Issue")
choice2$sub<- c("Yogi Adityanath", "Akhilesh Yadav", "Smriti Irani", "UP Media", "Law & Order")
